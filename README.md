...
There are input and output files in the DATASET.tar file. To conserve space, Gaussian output files are extracts of the archive portions of successful Gaussian runs. (To make these more human readable, see **gt-parsearchive.py** in https://github.com/mihali/gt-x.)
